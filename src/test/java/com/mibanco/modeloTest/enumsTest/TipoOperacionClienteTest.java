    ...
    class FuncionalidadEnumTest {
        ...
        void deberiaPoderUsarEnSwitchExpressions() {
            ...
            String resultado = switch (operacion) {
                case CREAR -> "Cliente creado";
                case ACTUALIZAR -> "Cliente actualizado";
                case MODIFICAR -> "Cliente modificado";
                case ELIMINAR -> "Cliente eliminado";
                case CONSULTAR -> "Cliente consultado";
                case RESTAURAR -> "Cliente restaurado";
                case BLOQUEAR -> "Cliente bloqueado";
                case DESBLOQUEAR -> "Cliente desbloqueado";
                case CAMBIAR_DATOS_CONTACTO -> "Datos de contacto cambiados";
            };
