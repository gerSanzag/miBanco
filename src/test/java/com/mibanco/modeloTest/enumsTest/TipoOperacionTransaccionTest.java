    ...
    class FuncionalidadEnumTest {
        ...
        void deberiaPoderUsarEnSwitchExpressions() {
            ...
            String resultado = switch (operacion) {
                case CREAR -> "Transacción creada";
                case ANULAR -> "Transacción anulada";
                case REVERSAR -> "Transacción revertida";
                case VERIFICAR -> "Transacción verificada";
                case AUTORIZAR -> "Transacción autorizada";
                case RECHAZAR -> "Transacción rechazada";
                case ACTUALIZAR -> "Transacción actualizada";
                case ELIMINAR -> "Transacción eliminada";
            };
